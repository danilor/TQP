...
class AdminClientesControllador  extends Controller {
	...
	public function principal(){
            ...
            $this->nombre_objeto = str_replace("s","",$this->nombre_objeto_plural);
	...
	public function modificar($usuario){
            ...
            $objeto = Cliente::find( $id_objeto ); //Busca al objeto con el ID
            $data["usuario"] = $usuario;
	...
	public function salvarInformacion( $usuario ){
            if( Input::get("id") != null ) {//Objeto a modificar
                $objeto = Cliente::find( Input::get("id") );
            }else { // Objeto nuevo
                $objeto = new Cliente() ;
            }
            //var_dump($objeto);
